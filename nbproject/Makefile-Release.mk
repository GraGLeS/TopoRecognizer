...
${OBJECTDIR}/LinearCurve.o: LinearCurve.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearCurve.o LinearCurve.cpp

${OBJECTDIR}/LocalPointset.o: LocalPointset.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LocalPointset.o LocalPointset.cpp
...
${OBJECTDIR}/PointCloudGenerator.o: PointCloudGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointCloudGenerator.o PointCloudGenerator.cpp

${OBJECTDIR}/QuadraticCurve.o: QuadraticCurve.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuadraticCurve.o QuadraticCurve.cpp

${OBJECTDIR}/Spline.o: Spline.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Spline.o Spline.cpp

${OBJECTDIR}/TriplelinePointsetClass.o: TriplelinePointsetClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TriplelinePointsetClass.o TriplelinePointsetClass.cpp
